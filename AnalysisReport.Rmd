...
Or I can use the simple t.test function in R with the parameter var.equal=FALSE.
...
In the sample population, orange juice (at dosages of 0.5 and 1.0 mg/day) was better for growing guinea pig teeth than ascorbic acid. With such an incredibly small sample size, however, further research is required to determine whether it is possible to build an army of guinea pigs with large incisors with just a carton of orange juice acquired from Trader Joe's. 
